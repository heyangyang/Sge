...
package com.sunny.game.engine.transition.tween.plugins
{
	 ...
	 */
	public class SSoundTransformPlugin extends STweenPlugin
	{
		/** @private **/
		...
		/** @private **/
		public function SSoundTransformPlugin()
		{
			super();
		...
		{
			if (!(target as STweenLite).target.hasOwnProperty("soundTransform"))
			{
				return false;
			}
			...
			var props : SSoundTransformProps = _value as SSoundTransformProps;
			if (props)
			{
				for (var p : String in props.propertyList)
				{
					addTween(_st, p, _st[p], props.propertyList[p], p);
				}
			}
			return true;
		}
