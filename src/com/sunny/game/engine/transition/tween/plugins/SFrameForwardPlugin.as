...
package com.sunny.game.engine.transition.tween.plugins
{
	 ...
	 */
	public class SFrameForwardPlugin extends STweenPlugin
	{
		/** @private **/
		...
		/** @private **/
		public function SFrameForwardPlugin()
		{
			super();
		...
		{
			if (!((target as STweenLite).target is MovieClip) || isNaN(_value as Number))
			{
				return false;
			}
			...
			_change = (typeof(_value) == "number") ? Number(_value) - _start : Number(_value);
