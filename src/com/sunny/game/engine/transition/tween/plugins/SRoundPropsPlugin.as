...
package com.sunny.game.engine.transition.tween.plugins
{
	 ...
	 */
	public class SRoundPropsPlugin extends STweenPlugin
	{
		/** @private **/
		...
		/** @private **/
		public function SRoundPropsPlugin()
		{
			super();
		...
		override public function setup(target : Object) : Boolean
		{
			...
			this.overwriteProps = this.overwriteProps.concat(_value as Array);
			return true;
		}
		...
		{
			var prop : String, multiProps : String, rp : Array = _tween.tweenProps.roundProps, pt : PropTween;
			var i : int = rp.length;
			while (--i > -1)
			{
				prop = rp[i];
