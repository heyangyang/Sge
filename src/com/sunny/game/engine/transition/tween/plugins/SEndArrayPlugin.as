...
package com.sunny.game.engine.transition.tween.plugins
{
	 ...
	 */
	public class SEndArrayPlugin extends STweenPlugin
	{
		/** @private **/
		...
		/** @private **/
		public function SEndArrayPlugin()
		{
			super();
		...
		{
			if (!((target as STweenLite).target is Array) || !(_value is Array))
			{
				return false;
			}
			init((target as STweenLite).target as Array, _value as Array);
			return true;
		}
