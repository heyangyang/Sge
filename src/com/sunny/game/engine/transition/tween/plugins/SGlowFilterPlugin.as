...
package com.sunny.game.engine.transition.tween.plugins
{
	 ...
	 */
	public class SGlowFilterPlugin extends FilterPlugin
	{
		/** @private **/
		...
		/** @private **/
		public function SGlowFilterPlugin()
		{
			super();
		...
		override public function setup(target : Object) : Boolean
		{
			...
			_type = GlowFilter;
			initFilter(_value, new GlowFilter(0xFFFFFF, 0, 0, 0, _value.strength || 1, _value.quality || 2, _value.inner, _value.knockout), _propNames);
			return true;
		}
	}
}