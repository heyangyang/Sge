...
package com.sunny.game.engine.transition.tween.plugins
{
	 ...
	 */
	public class SSetActualSizePlugin extends STweenPlugin
	{
		/** @private **/
		...
		/** @private **/
		public function SSetActualSizePlugin()
		{
			super();
		...
		override public function setup(target : Object) : Boolean
		{
			...
			if ("width" in _value && _target.width != _value.width)
			{
				addTween((_hasSetSize) ? this : _target, "width", _target.width, _value.width, "width");
				_setWidth = _hasSetSize;
			}
			if ("height" in _value && _target.height != _value.height)
			{
				addTween((_hasSetSize) ? this : _target, "height", _target.height, _value.height, "height");
