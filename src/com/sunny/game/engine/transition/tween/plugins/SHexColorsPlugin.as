...
package com.sunny.game.engine.transition.tween.plugins
{
	 ...
	 */
	public class SHexColorsPlugin extends STweenPlugin
	{
		/** @private **/
		...
		/** @private **/
		public function SHexColorsPlugin()
		{
			super();
		...
		override public function setup(target : Object) : Boolean
		{
			...
			{
				initColor((target as STweenLite).target, p, uint((target as STweenLite).target[p]), uint(_value[p]));
			}
			return true;
		}
