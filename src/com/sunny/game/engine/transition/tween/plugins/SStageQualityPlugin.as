...
package com.sunny.game.engine.transition.tween.plugins
{
	 ...
	 */
	public class SStageQualityPlugin extends STweenPlugin
	{
		/** @private **/
		...
		/** @private **/
		protected var _tween : STweenLite;

		/** @private **/
		public function SStageQualityPlugin()
		{
			super();
		...
		{
			if (!(_value.stage is Stage))
			{
				trace("You must define a 'stage' property for the stageQuality object in your tween.");
				return false;
			}
			_stage = _value.stage as Stage;
			_tween = target as STweenLite;
			_during = ("during" in _value) ? _value.during : StageQuality.MEDIUM;
			_after = ("after" in _value) ? _value.after : _stage.quality;
			return true;
		}
