...
package com.sunny.game.engine.transition.tween.plugins
{
	 ...
	 */
	public class SFrameLabelPlugin extends SFramePlugin
	{
		/** @private **/
		public static const API : Number = 1.0; //If the API/Framework for plugins changes in the future, this number helps determine compatibility

		/** @private **/
		public function SFrameLabelPlugin()
		{
			super();
		...
		{
			if (!(target as STweenLite).target is MovieClip)
			{
				return false;
			}
			_target = (target as STweenLite).target as MovieClip;
			this.frame = _target.currentFrame;
			var labels : Array = _target.currentLabels, label : String = _value as String, endFrame : int = _target.currentFrame;
