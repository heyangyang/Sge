...
package com.sunny.game.engine.transition.tween.plugins
{
	 ...
	 */
	public class SEndVectorPlugin extends STweenPlugin
	{
		/** @private **/
		...
		/** @private **/
		public function SEndVectorPlugin()
		{
			super();
		...
		{
			if (!((target as STweenLite).target is Vector.<Number>) || !(_value is Vector.<Number>))
			{
				return false;
			}
			init((target as STweenLite).target as Vector.<Number>, _value as Vector.<Number>);
			return true;
		}
