 ...
 * 			plugins in order to add features (like autoAlpha, color, blurFilter, etc.). TweenNano, however, 
 ...
 */	 
	public class TweenNano {
		...
		/** @private **/
		protected static var _reservedProps:Object = {ease:1, delay:1, useFrames:1, overwriteType:1, onComplete:1, onCompleteParams:1, runBackwards:1, immediateRender:1, onUpdate:1, onUpdateParams:1};
		...
		public function TweenNano(target:Object, duration:Number, vars:Object) {
			...
			if (a == null || int(this.vars.overwriteType) == 1 || this.vars.overwriteType == null) { 
...
//---- STATIC FUNCTIONS -------------------------------------------------------------------------
		...
		public static function delayedCall(delay:Number, onComplete:Function, onCompleteParams:Array=null, useFrames:Boolean=false):TweenNano {
			return new TweenNano(onComplete, 0, {delay:delay, onComplete:onComplete, onCompleteParams:onCompleteParams, useFrames:useFrames, overwriteType:0});
		}
