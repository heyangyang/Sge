package com.sunny.game.engine.loader.types
{
	...
	public class ImageItem extends LoadingItem
	{
		...
		override public function stop() : void
		{
			...
			{
				SDebug.debugPrint(this, "流关闭失败：" + id);
			}
			super.stop();
		}
		...
		override public function cleanListeners() : void
		{
			if (loader)
			{
				...
				removalTarget.removeEventListener(SResourceLoader.OPEN, onStartedHandler, false);
		...
		{
			return (type == SResourceLoader.TYPE_IMAGE);
		}

		override public function isSWF() : Boolean
		{
			return (type == SResourceLoader.TYPE_MOVIECLIP);
		}
