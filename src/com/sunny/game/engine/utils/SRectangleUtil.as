...
{
	import com.sunny.game.engine.enum.SScaleMode;
	import com.sunny.game.engine.lang.errors.SAbstractClassError;
	import com.sunny.game.engine.utils.display.SMatrixUtil;
	...
	public class SRectangleUtil
	{
		...
		/** @private */
		public function SRectangleUtil()
		{
		 ...
		 *
		 *  @see com.sunny.game.engine.gpu.utils.ScaleMode
		 */
		...
		{
			if (!SScaleMode.isValid(scaleMode))
		...
		public static function getBounds(rectangle : Rectangle, transformationMatrix : Matrix, resultRect : Rectangle = null) : Rectangle
		{
			...
			{
				SMatrixUtil.transformCoords(transformationMatrix, sPositions[i].x * rectangle.width, sPositions[i].y * rectangle.height, sHelperPoint);
