package com.sunny.game.engine.utils.data
{
	 ...
	 *
	 */
	public class SBitArray
	{
		public static const BIT_LEN : int = 32;

		private var data : Array = [];

		public function SBitArray(source : Array = null)
		{
			if (source)
		...
		public function createFromArray(source : Array) : void
		{
			...
			for (var i : int = 0; i < source.length; i++)
			{
				...
				else
				{
					...
					{
						setValue(n, SBitUtil.getBit(source[i], j));
						n++;
					}
				}
			}
		...
		public function getValue(v : int) : Boolean
		{
			...
			return SBitUtil.getBit(n, v % BIT_LEN);
		}
		...
		public function setValue(v : int, value : Boolean) : void
		{
			var dataIndex : int = int(v / BIT_LEN);
			var n : uint = data[dataIndex];
			data[dataIndex] = SBitUtil.setBit(n, v % BIT_LEN, value);
		}
