package com.sunny.game.engine.utils.data
{
	...
	public final class SHash
	{
		...
		public static function fromByteArray(byteArray : ByteArray, startValue : uint = 0) : uint
		{
			...
			{
				seed += uint(byteArray.readUnsignedByte() + (byteArray.readUnsignedByte() << 8) + (byteArray.readUnsignedByte() << 16) + (byteArray.readUnsignedByte() << 24));
				value += uint(byteArray.readUnsignedByte() + (byteArray.readUnsignedByte() << 8) + (byteArray.readUnsignedByte() << 16) + (byteArray.readUnsignedByte() << 24));
				returnValue += uint(byteArray.readUnsignedByte() + (byteArray.readUnsignedByte() << 8) + (byteArray.readUnsignedByte() << 16) + (byteArray.readUnsignedByte() << 24));
