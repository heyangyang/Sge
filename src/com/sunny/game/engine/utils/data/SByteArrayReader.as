package com.sunny.game.engine.utils.data
{
	...
	public class SByteArrayReader
	{
		...
		public function SByteArrayReader(data : ByteArray)
		{
			this.data = data;
		...
		public function readBits(n : uint) : int
		{
			...
			while (loop > 1)
			{
				temp += SBitUtil.getShiftedValue2(data.readUnsignedByte(), 8, bitPos, 8);
			...
			temp += SBitUtil.getShiftedValue2(data.readUnsignedByte(), 8, bitPos, last);
			bitPos = last;
			return temp;
		}
