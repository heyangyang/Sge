package com.sunny.game.engine.utils.data
{
	 ...
	 */
	public class SPropertyChangeEvent extends Event
	{
		//--------------------------------------------------------------------------
		//
		//  Class constants
		...
		public static function createUpdateEvent(
			...
			property:Object,
			oldValue:Object,
			newValue:Object):SPropertyChangeEvent
		{
			var event:SPropertyChangeEvent =
				new SPropertyChangeEvent(PROPERTY_CHANGE);
			
			event.kind = SPropertyChangeEventKind.UPDATE;
		 ...
		 *  @productversion Flex 3
		 */
		public function SPropertyChangeEvent(type:String, bubbles:Boolean = false,
		...
		{
			return new SPropertyChangeEvent(type, bubbles, cancelable, kind,
