package com.sunny.game.engine.utils
{
	...
	public class SReflectUtil
	{
		...
		public function SReflectUtil(obj : *) : void
		{
			obj = getClass(obj);
		 ...
		 *
		 */
		public static function getDescribeTypeCache(obj : *) : SReflectUtil
		{
			obj = getClass(obj);

			var ins : SReflectUtil = describeTypeCache[obj];
			if (!ins)
				ins = new SReflectUtil(obj);
		...
		{
			var ins : SReflectUtil = getDescribeTypeCache(obj);
			var result : Object = {};
		 ...
		 *
		 */
		public static function getPropertyList(obj : *, getDynamic : Boolean = false, onlyWriteable : Boolean = false) : Object
		{
			var ins : SReflectUtil = getDescribeTypeCache(obj);
			var result : Object = {};
