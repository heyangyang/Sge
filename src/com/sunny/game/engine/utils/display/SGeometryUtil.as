...
{
	import com.sunny.game.engine.enum.UIConst;
	 ...
	 *
	 */
	public final class SGeometryUtil
	{
		/**
		 * 拉伸对象到充满到某个区域
		 *
		...
		{
			var rect : Rectangle = SGeometryUtil.getRect(content);
		...
		public static function getRelativeLocation(v1 : *, v2 : *) : int
		{
			...
			return (r1.right <= r2.left ? 0 : r1.left >= r2.right ? 2 : 1) + (r1.bottom <= r2.top ? 0 : r1.top >= r2.bottom ? 6 : 3);
		}
		...
		public static function getRelativeLocation2(v1 : *, v2 : *) : int
		{
			var r1 : Rectangle = getRect(v1);
			var r2 : Rectangle = getRect(v2);
			return (r1.left < r2.left ? 0 : r1.right > r2.right ? 2 : 1) + (r1.top < r2.top ? 0 : r1.bottom > r2.bottom ? 6 : 3)
		}
	}
}
