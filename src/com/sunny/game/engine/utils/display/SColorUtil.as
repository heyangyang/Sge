package com.sunny.game.engine.utils.display
{
	 ...
	 *
	 */
	public final class SColorUtil
	{
		/** @private */
		public function SColorUtil()
		{
		 ...
		 * 默认白色
		 * */
		public static const TEXT_DEFAULT_INT:uint=0xe7e2d3;
		public static const TEXT_DEFAULT_STR:String="#e7e2d3";
		...
		public static function getColorString(rgb : uint) : String
		{
			return "#" + rgb.toString(16);
		}

		public static function lightUp(color : uint, up : uint) : uint
		{
			var r : uint = ((color & 0xff) + up) & 0xffffff;
			r = r > 255 ? 255 : r;
			var g : uint = ((color >> 8 & 0xff) + up) & 0xffffff;
			g = g > 255 ? 255 : g;
			var b : uint = ((color >> 16) + up) & 0xffffff;
			b = b > 255 ? 255 : b;
			color = r << 16 | g << 8 | b;
			return color;
		}
