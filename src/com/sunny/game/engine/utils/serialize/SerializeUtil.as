package com.sunny.game.engine.utils.serialize 
{
	...
	import com.sunny.game.engine.utils.SCommon;
...
//						xml.appendChild(bmpdXML);
		...
		{
			return null;//Base64.decodeToBitmapData(input);
		}
		...
		public static function deserializeBitmapDatas(input:XML):Vector.<BitmapData>
		{
			...
			else
			{
				...
				{
					bmpds[index++] = null;//Base64.decodeToBitmapData(String(bmpdXML));
				}
		...
		public static function serializeSimpleArray(array:Array):String
		{
			...
			{
				return array.join(SCommon.DELIM);
			}
		}
		...
		public static function deserializeSimpleArray(input:String):Array
		{
			...
			{
				return input.split(SCommon.DELIM);
			}
		}
		...
		public static function deserializeSimpleVector(input:String):*
		{
			...
			{
				return SArrayUtil.arrayToVector(input.split(SCommon.DELIM));
			}
		}
	}
