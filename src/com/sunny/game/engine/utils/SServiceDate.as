package com.sunny.game.engine.utils
{
	 ...
	 *
	 */
	public class SServiceDate
	{
		static private var _instance : SServiceDate;
		...
		static public function get instance() : SServiceDate
		{
			if (!_instance)
				_instance = new SServiceDate();
		 ...
		 *
		 */
		public function SServiceDate(serviceTime : Number = NaN, mode : int = 0)
		{
			_instance = this;
