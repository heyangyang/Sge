package com.sunny.game.engine.utils
{
	 ...
	 *
	 */
	public class SCountDown extends EventDispatcher
	{
		private var countDowns : Object;

		private static var _defaultCountDown : SCountDown;

		/**
		 * 默认计时器
		 */
		public static function get defaultCountDown() : SCountDown
		{
			if (!_defaultCountDown)
				_defaultCountDown = new SCountDown();
			return _defaultCountDown;
		}

		public function SCountDown()
		{
