package com.sunny.game.engine.fileformat.mp3
{
	...
	public class SMP3Decoder extends EventDispatcher
	{
		 ...
		 *
		 */
		public function get result() : Class
		{
			return _result;
		}
		...
		public function decode(bytes : ByteArray, rHandler : Function = null) : void
		{
			...
			{
				core_bytes = new core();
				core_bytes.endian = Endian.LITTLE_ENDIAN;
			}
			core_bytes.position = 0;

			var data : ByteArray = new ByteArray();
			data.endian = Endian.LITTLE_ENDIAN;
			data.writeBytes(core_bytes, 0, 56);
			createWithMP3(data, bytes);
			data.writeBytes(core_bytes, 907);
...
class MPEGFrame
{
	...
	public function setHeaderByteAt(index : uint, value : uint) : void
	{
		switch (index)
		{
			...
			{
				case 3:
					_version = MPEG_VERSION_1_0;
					break;
				case 2:
					_version = MPEG_VERSION_2_0;
					break;
				default:
