...
{
	import com.sunny.game.engine.utils.easing.TweenCacher;
	 ...
	 *
	 */
	public class SSakuraGenerator extends SBasicParticleGenerator
	{
		public var bitmapDatas : Array;
		public var density : Number;
		public var speed : Number;

		public function SSakuraGenerator(parent : Sprite, viewRect : Rectangle, density : Number = 0.3, speed : Number = 100, frameRate : Number = 30)
		{
		...
		override public function update() : void
		{
			...
			for (var i : int = children.length - 1; i >= 0; i--)
			{
				...
				child.life += elapsedTimes / 1000 * speed * 0.5;
				...
				{
					child.x += elapsedTimes / 1000 * speed * Math.cos(child.r) * child.scaleX;
					child.y += elapsedTimes / 1000 * speed * Math.sin(child.r) * child.scaleX;
					if (child.life < 20)
						child.alpha = child.life / 20;
					else if (child.life > 80)
						child.alpha = (100 - child.life) / 20;

					child.frameTimer -= elapsedTimes;
