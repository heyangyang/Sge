package com.sunny.game.engine.particle
{
	 ...
	 *
	 */
	public class SCloudGenerator extends SBasicParticleGenerator
	{
		public var speed : Number;
		public var direct : Number;

		public function SCloudGenerator(parent : Sprite, viewRect : Rectangle, layerNum : int = 3, direct : Number = 0.5, speed : Number = 30, alpha : Number = 0.2)
		{
		...
		override public function update() : void
		{
			...
			for (var i : int = children.length - 1; i >= 0; i--)
			{
				...
				child.life += elapsedTimes / 1000 * this.speed;
				if (child.life > 100)
				{
					remove(child);
				}
				...
				{
					child.x -= elapsedTimes / 1000 * child.speed * Math.cos(direct);
					child.y -= elapsedTimes / 1000 * child.speed * Math.sin(direct);
					if (child.life < 50)
