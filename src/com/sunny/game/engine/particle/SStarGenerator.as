package com.sunny.game.engine.particle
{
	...
	public class SStarGenerator extends SBasicParticleGenerator
	{
		...
		public function SStarGenerator(parent : Sprite, viewRect : Rectangle, speed : int = 100, flash : int = 1000, density : Number = 0.1)
		{
			this.speed = speed;
