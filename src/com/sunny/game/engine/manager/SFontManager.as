package com.sunny.game.engine.manager
{
	 ...
	 *
	 */
	public class SFontManager extends EventDispatcher
	{
		static private var _instance : SFontManager;

		static public function get instance() : SFontManager
		{
			if (!_instance)
				_instance = new SFontManager();
		...
		public function registerTextFormat(name : String, fontObj : *) : void
		{
			...
			if (fontObj is TextFormat)
				...
				textFormat = SUtil.createObject(TextFormat, fontObj);
