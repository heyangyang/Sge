package com.sunny.game.engine.manager
{
	 ...
	 *
	 */
	public class SBrowerManager extends EventDispatcher
	{
		private static var jsCode : Class;
		ExternalInterface.available && ExternalInterface.call("eval", new jsCode().toString());

		static private var _instance : SBrowerManager;

		static public function get instance() : SBrowerManager
		{
			if (!_instance)
				_instance = new SBrowerManager();
		...
		public function toDesktop() : void
		{
			ExternalInterface.call("BrowerManager.toDesktop");
		}
